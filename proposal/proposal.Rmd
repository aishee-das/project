...
```
The Enix Corporation is the most popular publisher in Japen, which is around 1.09. However, the Nintendo has the lowest sales in Japan, which is around 0.6. And mean japan sales of Enix Corporation is amost twice than that of Nintendo.
...
sample_data1 %>%
  ggplot(aes(x = User_Score, y = Global_Sales, col = "red")) +
  geom_jitter()+
