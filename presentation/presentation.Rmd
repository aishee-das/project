...
## The correlation between Publishers and sales: {data-background-image="img/gamecontr2.png"}
-From the bar chart, we can know that the publisher called palcom had the highrest mean global sales,which is 4.17. 
...
# The correlation between the year to release and the global sales for the Publishers with the highest mean global sales: {data-background-image="img/gamecontr2.png"}
::: columns
:::: {.column width="30%"}
A point graph showing the relationship between the year to release and the global sales for the Publishers with the highest mean global sales.
::::
...
publisher_year_global_sales %>%
  ...
  labs(title = "Global mean sales VS Year of release",
       subtitle = "the Publishers with the highest mean global sales",
       x = "year of release(from 1983 to 2016)", y = "mean global sales"
       ) +
  theme_minimal() +
  theme(axis.text.x = element_blank())
```
...
# Conclusion - Haoran:{data-background-image="img/gamecontr2.png"}
